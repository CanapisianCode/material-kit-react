...
function LightWaveTimeClock() {
  ...
  const handleClick = useCallback(() => {
    // Get the current time in a locale-specific format
    ...
    if (clockedIn) {
      setState((prevState) => ({
        ...
        clockedIn: false,
        // Add a new clock out entry to clockHistory
        clockHistory: [{ time: currentTime, action: "Clock Out" }, ...prevState.clockHistory],
        // Reset projectId
        projectId: "",
        // Reset taskId
        taskId: "",
      ...
      setState((prevState) => ({
        ...
        clockedIn: true,
        // Add a new clock in entry to clockHistory
        clockHistory: [{ time: currentTime, action: "Clock In" }, ...prevState.clockHistory],
      }));
    }
  }, [clockedIn]);
          ...
          <Grid item xs={11} sm={11} md={11} lg={8} xl={8}>
            <Card>
              ...
              <MKBox mx={2} align="center">
                <MKTypography variant="subtitle1" fontWeight={"medium"} mt={2}>
                  {currentTime}
                </MKTypography>
...
export default LightWaveTimeClock;
